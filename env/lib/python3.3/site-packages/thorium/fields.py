...
class TypedField(object):
    ...
    def set(self, value, allow_notset=False):
        if value is NotSet and allow_notset:
            self._value = NotSet
        elif value is NotSet and not allow_notset:
            raise errors.ValidationError('The value of {0} cannot be NotSet.'.format(self))
        else:
    ...
    def to_default(self):
        return self.set(self.default, allow_notset=True)
